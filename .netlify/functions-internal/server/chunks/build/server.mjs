import { defineAsyncComponent, getCurrentInstance, ref, watch, computed, inject, defineComponent, h, resolveComponent, hasInjectionContext, unref, toRef, isRef, shallowRef, onServerPrefetch, shallowReactive, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, withCtx, createBlock, createCommentVNode, openBlock, toDisplayString, renderSlot, watchEffect, readonly, nextTick, getCurrentScope, onScopeDispose, version, useSSRContext, createElementBlock, provide, Suspense, Fragment, createApp, reactive, createTextVNode, renderList, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, createSlots } from 'vue';
import { w as withLeadingSlash, s as joinURL, v as withoutTrailingSlash, D as withBase, A as hash, E as parseQuery, F as klona, G as defuFn, H as hasProtocol, I as withTrailingSlash, J as withQuery, K as isScriptProtocol, L as getContext, q as destr, M as sanitizeStatusCode, N as parse, O as getRequestHeader, P as isEqual, Q as setCookie, R as getCookie, S as deleteCookie, $ as $fetch$1, T as baseURL, f as createError$1, U as createHooks, V as toRouteMatcher, W as createRouter$1, B as defu, X as kebabCase } from '../_/nitro.mjs';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin, composableNames } from '@unhead/shared';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { nanoid } from 'nanoid';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSlot, ssrRenderTeleport, ssrRenderAttr, ssrRenderSuspense, ssrRenderStyle } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-DhHk7YxM.mjs')
  }
];
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-DVUhKJOS.mjs').then((r) => r["default"] || r.default || r));
const LazyEllipsis = defineAsyncComponent(() => import('./Ellipsis-BRNDna9e.mjs').then((r) => r["default"] || r.default || r));
...
const LazyDocsAside = defineAsyncComponent(() => import('./DocsAside-B_OmZCUJ.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(function() {
  return DocsAsideTree;
}).then((r) => r["default"] || r.default || r));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./DocsPageBottom-HM31pMhA.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./DocsPageLayout-CqGkvBur.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./DocsPrevNext-C8euEOm0.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsToc = defineAsyncComponent(() => import('./DocsToc-B18akkbL.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./DocsTocLinks-DAJEw7ih.mjs').then((r) => r["default"] || r.default || r));
const LazyEditOnLink = defineAsyncComponent(() => import('./EditOnLink-Ro0ElRV5.mjs').then((r) => r["default"] || r.default || r));
const LazySourceLink = defineAsyncComponent(() => import('./SourceLink-C3P8e4Lh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-ChZk-x3R.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-Clvjnnax.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-DXFyP9x9.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-oMxfCcy1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-BDNvuzU_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DqfM-rPY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Rr4C2oSF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BbZHqO0f.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CwZ19xmh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-SF5RL1aT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-CCa7f6CV.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-C2wvXgv1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BvAfhcjW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-tAlWFEr9.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-HX9uN3OM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-CV_sI7we.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-CQwniIRs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BP6Ydh7O.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-B65hUbuq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CBEU1pLv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-BNw60R6T.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-hmxA2i8S.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-KLDM5GXU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-BWzy_Te-.mjs').then((r) => r["default"] || r.default || r));
const LazyAlert = defineAsyncComponent(() => import('./Alert-D6JGsxUH.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import('./Badge-62vcXTS7.mjs').then((r) => r["default"] || r.default || r));
const LazyButtonLink = defineAsyncComponent(() => import('./ButtonLink-BH3ULLFN.mjs').then((r) => r["default"] || r.default || r));
const LazyCallout = defineAsyncComponent(() => import('./Callout-Cb2cGz4p.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeBlock = defineAsyncComponent(() => import('./CodeBlock-D8OCSXIT.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-Du7mc4zl.mjs').then((r) => r["default"] || r.default || r));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Container;
}).then((r) => r["default"] || r.default || r));
const LazyCopyButton = defineAsyncComponent(() => import('./CopyButton-BFQ3O4mZ.mjs').then((r) => r["default"] || r.default || r));
const LazyList = defineAsyncComponent(() => import('./List-BaHgRCFm.mjs').then((r) => r["default"] || r.default || r));
const LazyNuxtImg = defineAsyncComponent(() => import('./NuxtImg-CxzVct4r.mjs').then((r) => r["default"] || r.default || r));
const LazyProps = defineAsyncComponent(() => import('./Props-BNla13-9.mjs').then((r) => r["default"] || r.default || r));
const LazySandbox = defineAsyncComponent(() => import('./Sandbox-BrIMm--d.mjs').then((r) => r["default"] || r.default || r));
const LazyTabsHeader = defineAsyncComponent(() => import('./TabsHeader-cx6nfbwX.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./Terminal-BDoSFv6Q.mjs').then((r) => r["default"] || r.default || r));
const LazyVideoPlayer = defineAsyncComponent(() => import('./VideoPlayer-C6WjnbxF.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./IconCodeSandBox-DLXmuHKy.mjs').then((r) => r["default"] || r.default || r));
const LazyIconDocus = defineAsyncComponent(() => import('./IconDocus-DlSKgHTX.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxt = defineAsyncComponent(() => import('./IconNuxt-CZIU1Fqp.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./IconNuxtContent-F357FIa1.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./IconNuxtLabs-Q1X8S2ZQ.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./IconNuxtStudio-Ceg5ptSh.mjs').then((r) => r["default"] || r.default || r));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./IconStackBlitz-Bi5S_EXT.mjs').then((r) => r["default"] || r.default || r));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./IconVueTelescope-DmJ4qu8_.mjs').then((r) => r["default"] || r.default || r));
const LazyBlockHero = defineAsyncComponent(() => import('./BlockHero-ClhI9xwE.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./Card-BOgr8Fqe.mjs').then((r) => r["default"] || r.default || r));
const LazyCardGrid = defineAsyncComponent(() => import('./CardGrid-DxgwwV3r.mjs').then((r) => r["default"] || r.default || r));
const LazyVoltaBoard = defineAsyncComponent(() => import('./VoltaBoard-s0nZruOv.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlayground = defineAsyncComponent(() => import('./ComponentPlayground-CliM3gmT.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./ComponentPlaygroundData-MMf4f5uj.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./ComponentPlaygroundProps-D73y5b0t.mjs').then((r) => r["default"] || r.default || r));
...
const LazyPreviewLayout = defineAsyncComponent(() => import('./PreviewLayout-BgKzYN2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyTokensPlayground = defineAsyncComponent(() => import('./TokensPlayground-Cg0RNpNs.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-K9j0r4sN.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-iJcuwFTp.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BXpobPd1.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-B59WvZyX.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-DZWfHuCi.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BjrwTJg6.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-DbLXurpA.mjs').then((r) => r["default"] || r.default || r));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-CVfz7tly.mjs').then((r) => r["default"] || r.default || r));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-Bbefk3h_.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BJ6wMaPt.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BuXHMvO0.mjs').then((r) => r["default"] || r.default || r));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DtN6OrJB.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DtN6OrJB.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-i4HLeSp0.mjs').then((m) => m.default || m)),
  page: defineAsyncComponent(() => import('./page-Ugact4uc.mjs').then((m) => m.default || m))
};
...
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-2596513f"]]);
          ...
          if (unref(results).length > 0) {
            ...
            ssrRenderList(unref(results), (result, i) => {
              ...
              if ((_f = getNavItemMeta((_e = result == null ? void 0 : result.item) == null ? void 0 : _e.path)) == null ? void 0 : _f.directoryTitle) {
                _push2(`<span data-v-d9f83610>${ssrInterpolate((_h = getNavItemMeta((_g = result == null ? void 0 : result.item) == null ? void 0 : _g.path)) == null ? void 0 : _h.directoryTitle)} <span class="arrow" data-v-d9f83610>${`→`}</span></span>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              if ((_i = result == null ? void 0 : result.matches) == null ? void 0 : _i[0]) {
                _push2(`<p class="search-result-content-preview" data-v-d9f83610><span data-v-d9f83610>“</span><span data-v-d9f83610>${`${highlight(unref(q), (_j = result == null ? void 0 : result.matches) == null ? void 0 : _j[0])}` ?? ""}</span><span data-v-d9f83610>“</span></p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-OpM7R8Rx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Drw1wd_G.mjs'));
...
export { useVModel as A, usePinceauTheme as B, queryContent as C, fetchContentNavigation as D, get$1 as E, ensureArray as F, assertArray as G, apply as H, omit as I, sortList as J, withoutKeys as K, LayoutMetaSymbol as L, withKeys as M, createQuery as N, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$6 as a, useNuxtApp as b, useRoute as c, appLayoutTransition as d, entry$1 as default, _wrapInTransition as e, useRuntimeConfig as f, useContent as g, useRequestEvent as h, useContentHead as i, usePinceauRuntime as j, useContentPreview as k, layouts as l, computedStyle as m, __nuxt_component_0$4 as n, useDocus as o, __nuxt_component_0$3 as p, useAppConfig as q, useState as r, __nuxt_component_0$5 as s, useContentHelpers as t, useHead as u, useRouter as v, useClipboard as w, onClickOutside as x, useAsyncData as y, useColorMode as z };
